...
from transformers import AutoTokenizer, AutoModelForCausalLM, TextIteratorStreamer, Qwen2ForCausalLM
...
# 服务器路径
DEFAULT_CKPT_PATH = './Qwen1.5-0.5B-Chat'

# 服务器路径
DEFAULT_M3E_LARGE = './m3e-large'


def chat(tokenizer, query, history, stop_words_ids, **gen_kwargs):
    conversation = [
